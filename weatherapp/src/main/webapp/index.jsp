...
<head>
    ...
    <title>Weather App - By Umair</title>
...
<body>
    ...
    <div class="mainContainer">
     <form action="servelett" method="post" class="searchInput">
            <input type="text" placeholder="Enter City Name" id="searchInput" value="Meerut" name="city"/>
